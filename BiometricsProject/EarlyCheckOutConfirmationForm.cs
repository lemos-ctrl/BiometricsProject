...
{
    public class EarlyCheckOutConfirmationForm : Form
    {
        public EarlyCheckOutConfirmationForm(string userName, TimeSpan earlyBy)
        {
            this.Text = "Early Check-Out Confirmation";
            ...
            lblMessage.Text = $"{userName}, you are clocking out {timeString} early. Are you sure you want to proceed?";
            ...
            btnYes.Text = "Yes, Clock Out Early";
